            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2 class="ec-bg-title">Trang chủ</h2>
                        <h2 class="ec-title">Trang chủ</h2>
                        <p class="sub-title">Các mẫu laptop của chúng tôi</p>
                    </div>
                </div>
                ...
                <div class="col-md-12 text-center">
                    <ul class="ec-pro-tab-nav nav justify-content-center">
                        ...
                        <!-- <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-pro-for-men">Laptop Gaming</a></li>
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-pro-for-women">Laptop văn phòng</a></li>
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-pro-for-child">Laptop workstation</a></li> -->
                    </ul>
                </div>
                <!-- Tab End -->
            </div>
                    ...
                    <div class="row">
                        <div class="banner-block col-lg-6 col-md-12 margin-b-30" data-animation="slideInRight">
                            <div class="bnr-overlay">
                                <img src="public/LaptopHNL/Banner/bannerphu3.jpg" alt="" />
                                <div class="banner-text">
                                    <span class="ec-banner-stitle" style="color: white;">Hàng mới đến</span>
                                    <span class="ec-banner-title" style="color: white;">Laptop Gaming</span>
                                    <span class="ec-banner-discount" style="color: white;">Giảm giá 30%</span>
                                </div>
                                <div class="banner-content">
                                    <span class="ec-banner-btn"><a href="product-category?category=44">Xem ngay</a></span>
                                </div>
                            </div>
                        </div>
                        <div class="banner-block col-lg-6 col-md-12" data-animation="slideInLeft">
                            <div class="bnr-overlay">
                                <img src="public/LaptopHNL/Banner/bannerphu2.png" alt="" />
                                <div class="banner-text">
                                    <span class="ec-banner-stitle" style="color: white;">Xu hướng mới</span>
                                    <span class="ec-banner-title" style="color: white;">Laptop văn phòng<br></span>
                                    <span class="ec-banner-discount" style="color: white;">Giảm giá 20%</span>
                                </div>
                                <div class="banner-content">
                                    <span class="ec-banner-btn"><a href="product-category?category=46">Xem ngay</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        ...
                        <p class="sub-title">Các danh mục hàng đầu</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center ec-offer-content">
                    <h2 class="ec-offer-title">Laptop Workstation</h2>
                    <h3 class="ec-offer-stitle" data-animation="slideInDown">Siêu ưu đãi</h3>
                    <span class="ec-offer-img" data-animation="zoomIn"><img src="public/LaptopHNL/Banner/bannerphu1.jpg" alt="offer image" /></span>
                    <span class="ec-offer-desc">Dell</span>
                    <span class="ec-offer-price">Chỉ X.XXX.XXX Đ</span>
    ...
    <section class="section ec-new-product section-space-p" id="arrivals">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2 class="ec-bg-title">Hàng mới cập nhật</h2>
                        <h2 class="ec-title">Hàng mới cập nhật</h2>
                        <p class="sub-title">Hãy đón xem các mẫu laptop mới</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="ec-brand-outer">
                    <ul id="ec-brand-slider">
                        <!-- <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand" src="public/LaptopHNL/LogoHangSanPham/acer.png" /></a></div>
                        </li> -->
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand" src="public/LaptopHNL/LogoHangSanPham/apple.png" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand" src="public/LaptopHNL/LogoHangSanPham/Asus.jpg" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand" src="public/LaptopHNL/LogoHangSanPham/Razor.jpg" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand" src="public/LaptopHNL/LogoHangSanPham/HP.png" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand" src="public/LaptopHNL/LogoHangSanPham/Lenovo.png" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand" src="public/LaptopHNL/LogoHangSanPham/Logitech.png" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand" src="public/LaptopHNL/LogoHangSanPham/MSI.jpg" /></a></div>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section class="section ec-instagram-section module section-space-p" id="insta">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2 class="ec-bg-title">Một số mẫu laptop bán chạy</h2>
                        <h2 class="ec-title">Một số mẫu laptop bán chạy</h2>
                        <p class="sub-title">Mời các bạn tham khảo</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="container" data-animation="fadeIn">
                    <div class="insta-auto">
                        ...
                        <div class="ec-insta-item">      
                                <a href="#" target="_blank"><img src="public\LaptopHNL\SanPham\Laptopgaming\Acer\acergaming1a.jpg" alt="insta"></a>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                                <a href="#" target="_blank"><img src="public\LaptopHNL\SanPham\Laptopgaming\Asus\asusgaming1a.jpg" alt="insta"></a>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                                <a href="#" target="_blank"><img src="public\LaptopHNL\SanPham\Laptopgaming\Asus\asusgaming2a.jpg" alt="insta"></a>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                                <a href="#" target="_blank"><img src="public\LaptopHNL\SanPham\Laptopgaming\Dell\dellgaming1a.jpg" alt="insta"></a>
                        </div>
                        <!-- instagram item -->
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                                <a href="#" target="_blank"><img src="public\LaptopHNL\SanPham\Laptopgaming\Dell\dellgaming2a.jpg" alt="insta"></a>
                        </div>
                        <!-- instagram item -->
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                                <a href="#" target="_blank"><img src="public\LaptopHNL\SanPham\Laptopgaming\HP\HPgaming1a.jpg" alt="insta"></a>
                        </div>
                        <!-- instagram item -->
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                                <a href="#" target="_blank"><img src="public\LaptopHNL\SanPham\Laptopgaming\Lenovo\lenovogaming1a.jpg" alt="insta"></a>
                        </div>
                        <!-- instagram item -->
                    </div>
                </div>
